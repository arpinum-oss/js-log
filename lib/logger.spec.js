...
describe('Logger', () => {
  ...
  it('wont be created with level not a string', () => {
  ...
  it('wont be created with category not a string', () => {
    const creation = () => create({category: 3});

    creation.should.throw(Error, 'category must be a string');
  });

  it('wont be created with filter not a string', () => {
    const creation = () => create({filter: 3});

    creation.should.throw(Error, 'filter must be a string');
  });

  it('wont be created with fileName not a string', () => {
    const creation = () => create({fileName: 3});

    creation.should.throw(Error, 'fileName must be a string');
  });

  it('wont be created with console having log property not a function', () => {
    const creation = () => create({console: Object.assign({}, consoleSpy, {log: 3})});

    creation.should.throw(Error, 'console#log must be a function');
  });

  it('wont be created with console having warn property not a function', () => {
    const creation = () => create({console: Object.assign({}, consoleSpy, {warn: 3})});

    creation.should.throw(Error, 'console#warn must be a function');
  });

  it('wont be created with console having error property not a function', () => {
    const creation = () => create({console: Object.assign({}, consoleSpy, {error: 3})});
